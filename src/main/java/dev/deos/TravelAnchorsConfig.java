...
public class TravelAnchorsConfig {
    public static final BuilderCodec<TravelAnchorsConfig> CODEC = BuilderCodec
            ...
            .append(new KeyedCodec<Double>("MaximumAngle", Codec.DOUBLE),
                    (TravelAnchorsConfig, val, extraInfo) -> TravelAnchorsConfig.maximumAngle = val,
                    (TravelAnchorsConfig, extraInfo) -> TravelAnchorsConfig.maximumAngle).add()
